...
class Tier2EvidenceExporter:
    ...
    def export_run(
        ...
        *,
        ...
        schema_source = self.project_root / "config" / "tier2_ai_schema.json"
        prompt_source = self.project_root / "docs" / "tier2_ai_prompt_template.md"
        shutil.copyfile(schema_source, root / "tier2_ai_schema.json")
        shutil.copyfile(prompt_source, root / "tier2_ai_prompt_template.md")
