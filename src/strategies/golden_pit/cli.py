#!/usr/bin/env python3
"""Golden Pit strategy CLI, hosted by the multi-strategy platform."""
...
def _export_tier2_command(args) -> None:
    from src.strategies.golden_pit.evidence_research import Tier2EvidenceExporter
    from src.strategies.golden_pit.persistence.tier2_repository import Tier2Repository
...
def _import_tier2_command(args) -> None:
    from src.strategies.golden_pit.evidence_research import Tier2AssessmentImporter
    from src.strategies.golden_pit.persistence.tier2_repository import Tier2Repository
